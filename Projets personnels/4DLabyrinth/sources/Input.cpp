...
void Input::SetEnter(bool val)
{
    m_Enter = val;
}

bool Input::GetBack() const
{
    if(this == 0)
        return 0;
    return m_Back;
...
void Input::SetBack(bool val)
{
    m_Back = val;
}

bool Input::Getpgup() const
{
    if(this == 0)
        return 0;
    return m_pgup;
...
void Input::Setpgup(bool val)
{
    m_pgup = val;
}

bool Input::Getpgdown() const
{
    if(this == 0)
        return 0;
    return m_pgdown;
...
bool Input::GetBouton() const
{
    ...
    return GetA()||Getbas()||GetD()||Getdroite()||GetE()||GetF()||GetG()||\
           ...
           GetEnter()||GetBack()||Getpgup()||Getpgdown();
}

void Input::Actualiser(bool &done)
{
    SDL_Event event;
